...
export const activateSettings = () => ({
	type: ACTIVATE_SETTINGS_SCREEN,
	section: MainSection.Settings
})

export const activateInteractive = () => ({
	type: ACTIVATE_INTERACTIVE_SCREEN,
	section: MainSection.Interactive
})
...
export const activateAbout = () => ({
	type: ACTIVATE_ABOUT,
	section: MainSection.About
})

export const activateListen = () => ({
	type: ACTIVATE_LISTEN,
	section: MainSection.Listen
})

export const activateAdmin = () => ({
	type: ACTIVATE_ADMIN,
	section: MainSection.Admin
})
