...
var prefetchData = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(path) {
    var _this = this;

    var routes, isStaticRoute, _ref4, _initialProps, propsMap, initialProps;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            isStaticRoute = routes.includes(path);
          ...
          case 30:
            ...
            _context4.next = 33;
            return Promise.all([window.reactStaticGetComponentForPath(path)].concat(_toConsumableArray(Object.keys(propsMap).map(function () {
              var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(key) {
                var hash, _ref6, prop;
...
var prefetchTemplate = function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(path) {
    var pathTemplate;
  ...
  return function prefetchTemplate(_x3) {
    return _ref7.apply(this, arguments);
  };
}();

var prefetch = exports.prefetch = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee6(path) {
...
function getRouteProps(Comp) {
  ...
  return (0, _reactRouterDom.withRouter)((_temp2 = _class = function (_Component) {
    ...
    function GetRouteProps() {
      ...
      return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref11 = GetRouteProps.__proto__ || Object.getPrototypeOf(GetRouteProps)).call.apply(_ref11, [this].concat(args))), _this2), _this2.state = {
        loaded: false
      }, _this2.loadRouteProps = function () {
        var _this3;

        return (_this3 = _this2).__loadRouteProps__REACT_HOT_LOADER__.apply(_this3, arguments);
      }, _temp), _possibleConstructorReturn(_this2, _ret);
    }

    _createClass(GetRouteProps, [{
      key: '__loadRouteProps__REACT_HOT_LOADER__',
      value: function __loadRouteProps__REACT_HOT_LOADER__() {
        return this.__loadRouteProps__REACT_HOT_LOADER__.apply(this, arguments);
      }
    }, {
      ...
      value: function componentWillReceiveProps(nextProps) {
        if (process.env.REACT_STATIC_ENV === 'development') {
          if (this.props.location.pathname + this.props.location.search !== nextProps.location.pathname + nextProps.location.search) {
          ...
          return _regenerator2.default.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  _props$location = _this4.props.location, pathname = _props$location.pathname, search = _props$location.search;
                  path = (0, _shared.pathJoin)('' + pathname + search);
                  _context7.next = 4;
                  return prefetch(path);

                case 4:
                  if (!_this4.unmounting) {
                    _context7.next = 6;
                    break;
                  }
...
function getSiteProps(Comp) {
  ...
  return _temp4 = _class2 = function (_Component2) {
    ...
    function GetSiteProps() {
      ...
      return _ret2 = (_temp3 = (_this5 = _possibleConstructorReturn(this, (_ref13 = GetSiteProps.__proto__ || Object.getPrototypeOf(GetSiteProps)).call.apply(_ref13, [this].concat(args))), _this5), _this5.state = {
        siteProps: false
    ...
    _createClass(GetSiteProps, [{
      key: 'componentWillMount',
      value: function () {
        var _ref14 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee8() {
          var _ref15, siteProps;
...
var Prefetch = exports.Prefetch = function (_Component3) {
  ...
  _createClass(Prefetch, [{
    ...
    value: function () {
      var _ref16 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee9() {
...
var PrefetchWhenSeen = exports.PrefetchWhenSeen = function (_Component4) {
  ...
  function PrefetchWhenSeen() {
    ...
    return _ret3 = (_temp5 = (_this7 = _possibleConstructorReturn(this, (_ref17 = PrefetchWhenSeen.__proto__ || Object.getPrototypeOf(PrefetchWhenSeen)).call.apply(_ref17, [this].concat(args))), _this7), _this7.runPrefetch = function () {
      var _this8;

      return (_this8 = _this7).__runPrefetch__REACT_HOT_LOADER__.apply(_this8, arguments);
    }, _this7.handleRef = function () {
      var _this9;

      return (_this9 = _this7).__handleRef__REACT_HOT_LOADER__.apply(_this9, arguments);
    }, _temp5), _possibleConstructorReturn(_this7, _ret3);
  }
  ...
  _createClass(PrefetchWhenSeen, [{
    ...
    value: function __runPrefetch__REACT_HOT_LOADER__() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee10() {
        var _props2, path, onLoad, data;

        return _regenerator2.default.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _props2 = _this10.props, path = _props2.path, onLoad = _props2.onLoad;
                _context10.next = 3;
                return prefetch(path);
...
var Router = exports.Router = function (_Component5) {
  ...
  function Router() {
    ...
    return _ret4 = (_temp6 = (_this11 = _possibleConstructorReturn(this, (_ref19 = Router.__proto__ || Object.getPrototypeOf(Router)).call.apply(_ref19, [this].concat(args))), _this11), _this11.state = {
      error: null,
      errorInfo: null
      ...
      if (staticURL) {
        ...
        global.__reactStaticRouterHistory = resolvedHistory;['push', 'replace'].forEach(function (method) {
          ...
          resolvedHistory[method] = function () {
            var _ref20 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee11() {
...
var _temp7 = function () {
  ...
  __REACT_HOT_LOADER__.register(prefetchData, 'prefetchData', 'src/index.js');

  __REACT_HOT_LOADER__.register(prefetchTemplate, 'prefetchTemplate', 'src/index.js');
