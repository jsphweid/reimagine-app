...
var exportRoutes = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(_ref2) {
    ...
    var Comp, DocumentTemplate, siteProps, seenProps, sharedProps, routeInfo;
          ...
          case 17:
            return _context4.abrupt('return', Promise.all(config.routes.map(function () {
              var _ref6 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(route) {
                var staticURL, InitialPropsContext, renderMeta, chunkNames, head, clientScripts, CompWithContext, renderToStringAndExtract, appHtml, HtmlWithMeta, HeadWithMeta, BodyWithMeta, html, htmlFilename;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        CompWithContext = function CompWithContext(props) {
                        ...
                        _context3.next = 11;
                        return config.renderToHtml(renderToStringAndExtract, CompWithContext, renderMeta, clientStats);
                      ...
                      case 11:
                        ...
                        HeadWithMeta = function HeadWithMeta(_ref8) {
                          ...
                          return _react2.default.createElement(
                            ...
                            head.meta,
                            _react2.default.createElement('link', { rel: 'preload', href: config.publicPath + 'routeInfo.json' }),
                            head.link,
                            process.env.extractedCSSpath && _react2.default.createElement('link', { rel: 'stylesheet', href: '' + config.publicPath + process.env.extractedCSSpath }),
                            head.noscript,
                            head.script,
                            head.style,
                            childrenArray
                        ...
                        BodyWithMeta = function BodyWithMeta(_ref9) {
                          ...
                          return _react2.default.createElement(
                            ...
                            clientScripts.map(function (script) {
                              return _react2.default.createElement('script', { defer: true, type: 'text/javascript', src: '' + config.publicPath + script });
                            })
                          );
                        };
        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            file = '\n    import React, { Component } from \'react\'\n    import { Route } from \'react-router-dom\'\n    import universal, { setHasBabelPlugin } from \'react-universal-component\'\n\n    setHasBabelPlugin()\n\n    const universalOptions = {\n      loading: () => null,\n      error: () => null,\n    }\n\n    ' + templates.map(function (template, index) {
              return 'const t_' + index + ' = universal(import(\'' + _path2.default.relative(config.paths.DIST, _path2.default.resolve(config.paths.ROOT, template)) + '\'), universalOptions)';
            }).join('\n') + '\n\n    // Template Map\n    const templateMap = {\n      ' + templates.map(function (template, index) {
              return 't_' + index;
